...
public class Test_A06_GameState {
    private String SITNETID = Test_A06_GameState.class.getCanonicalName().split("\\.")[1];
    ...
    public void test_load_and_toString() {
        ...
        for(int i = 0; i < allFiles.length; i++) {
            boolean threwException = false;
            try (
                Scanner fileInput = new Scanner(new File(allFiles[i]));
            ) {
                ...
                throw new AssertionError("Could not find file: " + allFiles[i], e);
            }
    ...
    public void test_save() {
        ...
        for(int i = 0; i < allFiles.length; i++) {            
            ...
            String saveFilename = SITNETID + "_" + allFiles[i];
            try {
